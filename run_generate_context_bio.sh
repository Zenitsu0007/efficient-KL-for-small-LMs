...
#SBATCH --job-name=bio_generation_context
...
#SBATCH --mem=30g
#SBATCH --output=bio_generation_context.log
...
python generate_context.py --device_id 0 --domain bio --seed 498 --total_size 500000
