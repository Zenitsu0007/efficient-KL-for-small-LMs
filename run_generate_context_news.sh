...
#SBATCH --job-name=news_generation_context
...
#SBATCH --mem=30g
#SBATCH --output=news_generation_context.log
...
python generate_context.py --device_id 0 --domain news --seed 450 --total_size 800000
